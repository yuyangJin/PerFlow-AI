...
class TraceAnalysis:
    ...
    def get_profiler_steps(self) -> List[int]:
        ...
        """
        return StragglerAnalysis.get_profiler_steps(self.trace)
    ...
    def get_potential_stragglers(
        ...
        straggler_identification_impl = None, # TODO
    ) -> List[int]:
        r"""
    ...
    def get_aten_op_kernels_and_delay(
        ...
        return CudaKernelAnalysis.get_aten_op_kernels_and_delay(self.trace, ranks, sort_by)
    ...
    def generate_trace_with_counters(
        ...
        def add_time_series(
            series_dict: Dict[int, Any], counter_name: str, counter_col: str
        ):
            ...
            for rank, series in series_dict.items():
                ...
                ce = self.trace.convert_time_series_to_events(
    ...
    def get_queue_length_summary(
        ...
        """
        return TraceCounters.get_queue_length_summary(self.trace, ranks)

    def get_queue_length_summary_from_time_series(
        self,
        queue_length_dict: Dict[int, Any],
    ):
        r"""
        Queue length is defined as the number of outstanding CUDA operations on a stream. This
        functions calculates the summary statistics for the queue length on each CUDA stream for
    ...
    def get_queue_length_time_series(
        ...
        """
        return TraceCounters.get_queue_length_time_series(self.trace, ranks)

    def get_time_spent_blocked_on_full_queue(
        self,
        queue_length_dict: Dict[int, Any],
        max_queue_length: int = 0, # TODO
    ):
        r"""
        ...
        return TraceCounters.get_time_spent_blocked_on_full_queue(
            self.trace, queue_length_dict, max_queue_length
        )
    ...
    def get_memory_bw_summary(
        ...
        Returns:
            pd.DataFrame or None
                ...
                The function returns None when the dataframe is empty.
        """
        return TraceCounters.get_memory_bw_summary(self.trace, ranks)
    ...
    def get_memory_bw_time_series(
        ...
        """
        return TraceCounters.get_memory_bw_time_series(self.trace, ranks)
    ...
    def get_cupti_counter_data_with_operators(
        ...
        * Counter values are logged in the `args` section of the trace.
        ...
        """
        return CuptiCounterAnalysis.get_counter_data_with_operators(self.trace, ranks)
    ...
    #         self.trace, rank, annotation, instance_id, data_load_events=data_load_events
    #     )
