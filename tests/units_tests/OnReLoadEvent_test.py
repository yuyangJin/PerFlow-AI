...
def test_OffReLoadEvent():
    event = OffReLoadEvent(id=1, type=EventType.OFFL, name="Event1", timestamp=1672531200, duration=3600, load_ratio=0.5, load_type=LoadType.GPU2CPU_PCIE, stage_id=1, microbatch_id=2, chunk_id=3)
    ...
    assert event.get_load_type() == LoadType.GPU2CPU_PCIE
